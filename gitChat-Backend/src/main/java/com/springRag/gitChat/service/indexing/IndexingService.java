...
import com.springRag.gitChat.exceptions.BadRequestException;
import com.springRag.gitChat.exceptions.NotFoundException;
import com.springRag.gitChat.repository.RepositoryRepository;
import com.springRag.gitChat.service.UserService;
import com.springRag.gitChat.service.ai.RagSettings;
import com.springRag.gitChat.service.github.GitHubRateLimiter;
...
public class IndexingService {
    ...
    private void doIndex(UUID repoId, UUID userId) {
        Repository repo = repositoryRepository.findById(repoId)
                .orElseThrow(() -> new NotFoundException("Repository not found"));
        String token = userService.decryptAccessToken(userService.findById(userId));
